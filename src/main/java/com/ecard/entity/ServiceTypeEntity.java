...
public class ServiceTypeEntity {
	...
	/**
	 * create time:2017年3月22日
	 * @return the strServiceTypeDesc
	 */
	public String getStrServiceTypeDesc() {
		return strServiceTypeDesc;
	}
	
	/**
	 * create time:2017年3月22日
	 * @param strServiceTypeDesc the strServiceTypeDesc to set
	 */
	public void setStrServiceTypeDesc(String strServiceTypeDesc) {
		this.strServiceTypeDesc = strServiceTypeDesc;
	}
