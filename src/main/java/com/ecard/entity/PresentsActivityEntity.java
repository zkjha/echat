...
public class PresentsActivityEntity {
	...
	private Map<String,Boolean> mapActivityAttribute=null;
	...
	public void setMapActivityAttribute(String strPresentsKind,Boolean presentsValue)
	{
		mapActivityAttribute.put(strPresentsKind, presentsValue);
	}
	
	public Map<String,Boolean> getMapActivityAttribute()
	{
		return mapActivityAttribute;
	}
