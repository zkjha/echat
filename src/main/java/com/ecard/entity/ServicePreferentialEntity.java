...
public class ServicePreferentialEntity {
	...
	/**
	 * create time:2017年3月30日
	 * @return the strPreferentialId
	 */
	public String getStrPreferentialId() {
		return strPreferentialId;
	}
	
	/**
	 * create time:2017年3月30日
	 * @param strPreferentialId the strPreferentialId to set
	 */
	public void setStrPreferentialId(String strPreferentialId) {
		this.strPreferentialId = strPreferentialId;
	}
	...
	/**
	 * create time:2017年3月30日
	 * @param strLevelsId the strLevelsId to set
	 */
	...
	/**
	 * create time:2017年3月30日
	 * @param strLevelsName the strLevelsName to set
	 */
