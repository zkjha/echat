    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        +'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/weixin/generateOrder.css">'
        document.write(css);
        })();
        </script>
        <title>支付</title>
        ...
        <body>
        <div class="mobile_content" ng-controller="generateOrder">
        <alert></alert>
        <comfirm></comfirm>
        <toast></toast>
        ...
        <script type="text/javascript">
        (function(){
        var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+ EK.STATIC_ROOT+'js/weixin/generateOrder"><\/script>';
