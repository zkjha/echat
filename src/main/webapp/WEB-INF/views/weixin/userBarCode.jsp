...
<script type="text/javascript">
    ...
    +'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/weixin/userBarCode.css">'
    document.write(css);
    })();
</script>
...
<body ng-controller="homepage">
	...
	<div class="mobile_content">
		<div class="z-vipCard-QRcode">
			<div class="z-vipCard-QRcode-img">
				<img ng-src="{{strQrCode}}"/>
			</div>
			<p>请将此页面出示给4s店工作人员扫描</p>
		</div>
	</div>
</body>
</html>
