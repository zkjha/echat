    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        +'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/weixin/voucherTicketInfo.css">'
        document.write(css);
        })();
        </script>
        ...
        <body ng-controller="voucherTicketInfo">
        <alert></alert>
        <comfirm></comfirm>
        <toast></toast>
        <div ng-view></div>
        ...
        <script type="text/javascript">
        (function(){
        var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+ EK.STATIC_ROOT+'js/weixin/voucherTicketInfo"><\/script>';
