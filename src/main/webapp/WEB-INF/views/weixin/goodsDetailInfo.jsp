    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        +'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/weixin/goodsDetailinfo.css">'
        document.write(css);
        })();
        </script>
        <title>微信登录</title>
        ...
        <comfirm></comfirm>
        <toast></toast>
        <div ng-include="'/static/temp/weixin/goodsDetailinfo.html'"></div>

        </body>
        </html>
        <script type="text/javascript">
        (function(){
        var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+ EK.STATIC_ROOT+'js/weixin/goodsDetailinfo"><\/script>';
