...
<head>
   ...
   <script type="text/javascript">
    ...
    +'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/admin/cashier.css">'
    document.write(css);
    })();
    </script>
...
<script type="text/javascript">
    (function(){
    var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+ EK.STATIC_ROOT+'js/admin/cashier"><\/script>';
