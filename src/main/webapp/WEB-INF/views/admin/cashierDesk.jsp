...
+'<link type="text/css" rel="stylesheet" href="'+ EK.STATIC_ROOT+'css/pages/admin/cashierDesk.css">'
document.write(css);
})();
</script>
...
<body  ng-controller="cashierCtrl" >
...
<div ng-include="'/static/temp/admin/cashierHeader.html'"></div>

<div class="-lpy-main-content " ng-style="lpyMainCotentStyle" >
    <%--用户信息查询的引入--%>
    <div ng-include="'/static/temp/admin/cashierDesk/usertop.html'"></div>
    <%--用户信息查询的商品引入--%>
    <%--<div ng-include="'/static/temp/admin/cashierDesk/userbottom.html'"></div>--%>
    <div ng-view></div>
</div>
...
<script type="text/javascript">
(function(){
var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+ EK.STATIC_ROOT+'js/admin/cashierDesk"><\/script>';
