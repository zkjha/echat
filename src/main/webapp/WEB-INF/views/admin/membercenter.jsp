    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <body ng-controller="menbercentCtrl" >
        <input type="hidden" ng-init="membercenter=true" ng-model="membercenter"/>
        <alert></alert>
        <comfirm></comfirm>
        <toast></toast>
        ...
        <script type="text/javascript">
        (function(){
        var footer = '<script src="'+ EK.STATIC_ROOT+'js/lib/require.js" data-main="'+
        EK.STATIC_ROOT+'js/admin/membercenter"><\/script>';
